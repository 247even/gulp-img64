...
describe('gulp-img64', function() {
	describe('in buffer mode', function() {
		...
		it('should ignore external images', function(done) {

			var filename = path.join(__dirname, '/fixtures/input_with_external_images.html');
			...
			stream.on('data', function(newFile) {
				assert.equal(String(newFile.contents), fs.readFileSync(path.join(__dirname, '/fixtures/output_with_external_images.html'), 'utf8'));
				done();
			});
